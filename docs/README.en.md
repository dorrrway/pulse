...
- Pinned screenshot floating windows can now be resized proportionally by dragging their edges or corners while keeping the same borderless image-window style.
