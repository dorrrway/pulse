...
- Refined the screenshot editor text tool: text input now uses a transparent, center-aligned field, clicking the canvas commits the input, and existing text labels can be dragged to reposition them.
